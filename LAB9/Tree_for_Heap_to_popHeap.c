...
void printHeap(Record element[], int count){
...
void popHeap(Record element[], int *count) {
    ...
    printf("%d\n%s, %s, %s, %s\n", element[*count - 1].priority, element[*count - 1].who, element[*count - 1].event, element[*count - 1].date, element[*count - 1].location);
    (*count)--;
}
